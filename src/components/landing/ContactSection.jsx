  ...
  return (
    <div id="contact" className="relative isolate bg-white px-6 py-24 dark:bg-gray-900 sm:py-32 lg:px-8 scroll-mt-16">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-base font-semibold leading-7 text-primary-text-600 dark:text-primary-text-400">Contact sales</h2>
          ...
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-lg border border-gray-200 bg-white px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:border-gray-800 dark:bg-gray-900 dark:text-white dark:ring-gray-700 dark:focus:ring-primary-500 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div>
