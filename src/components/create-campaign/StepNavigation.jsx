        ...
        {isFirstStep && (
          <>
            ...
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg border border-primary-200 bg-primary-50 px-4 py-2.5 text-sm font-medium text-primary-700 hover:bg-primary-100 dark:border-primary-900 dark:bg-primary-900/30 dark:text-primary-text-400 dark:hover:bg-primary-900/50 disabled:opacity-50 disabled:cursor-not-allowed"
            >
