// src/components/signin/SocialSignIn.jsx
import React, { useState } from 'react';
import { Link } from 'react-router-dom';

export default function SocialSignIn({ handleGoogleSignIn }) {
    ...
    <div className="mx-auto w-[90%] sm:w-full sm:max-w-[480px]">
      ...
      <div className="mt-6">
        <button
          ...
          disabled={isLoading}
          className="flex w-full items-center justify-center gap-3 rounded-md bg-white dark:bg-gray-800 px-3 py-1.5 text-sm font-semibold text-gray-900 dark:text-white outline outline-1 -outline-offset-1 outline-gray-300 dark:outline-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0] disabled:opacity-70 disabled:cursor-not-allowed"
        >
          {isLoading ? (
            <>
