    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-[90%] sm:w-full max-w-md rounded-lg bg-white shadow-xl dark:bg-gray-900 max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-6 pb-4">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Use Template</h2>
          <button 
            onClick={onClose}
            ...
            <div className="py-8 text-center">
              <div className="flex flex-col items-center justify-center">
                ...
                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                  You don't have any templates yet. Create a template first.
                </p>
              </div>
            </div>
          )}
          ...
          {!isLoading && !error && templates.length > 0 && (
            <>
              <p className="mb-3 text-sm text-gray-600 dark:text-gray-400">
                Select a template to use. This will copy caption and outro settings.
              </p>
            </>
          )}
        </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <span className="inline-flex items-center rounded-full bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
                        {template.captionType || 'Standard'} captions
                      </span>
                      {template.showOutro && (
